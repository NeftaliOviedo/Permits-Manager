    ...
    <div class="List">
            <table class="table">
                <thead>
                    ...
                    <th scope="col">Type fo Permit</th>
                    <th scope="col">Date</th>
                    <th scope="col">Action</th>
                    </tr>
                </thead>
                    <tr v-bind:key="permit.id" v-for="permit in permits" >
                    ...
                    <td>
                        ...
                        <button @click="deleteItem(permit.id)" type="button" class="btn btn-danger btn-sm"> 
